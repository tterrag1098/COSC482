...
Models* Models::createSphereOBJ(GLfloat r, GLint ilon, GLint ilat)
{
    return createPartialSphereOBJ(r, ilon, ilat, 0, 2*PI, -PI/2, PI/2);
}
...
Models* Models::createPartialSphereOBJ(GLfloat r, GLint ilon, GLint ilat, GLfloat begintheta, GLfloat endtheta, GLfloat beginpsi, GLfloat endpsi)
{
...
Models* Models::createTorusOBJ(GLfloat irad, GLfloat orad, GLint ilon, GLint ilat)
{
    return createPartialTorusOBJ(irad, orad, ilon, ilat, -PI, PI, -PI, PI);
}
...
Models* Models::createPartialTorusOBJ(GLfloat irad, GLfloat orad, GLint ilon, GLint ilat, GLfloat begintheta, GLfloat endtheta, GLfloat beginpsi, GLfloat endpsi)
{
...
Models* Models::createTrefoilOBJ(GLfloat amp, GLfloat numtwists, GLfloat rmaj, GLfloat rmin, GLfloat elongfact, GLint ilon, GLint ilat)
{
    GLfloat cx, cy, cz;
    GLfloat x1, y1, z1;
    GLfloat x2, y2, z2;
...
Models* Models::createUmbilicTorusOBJ(GLint ilon, GLint ilat)
{
    resetArraySize(ilon, ilat);
...
Models* Models::createBraidedTorusOBJ(GLfloat amp, GLfloat numtwists, GLfloat rmaj, GLfloat rmin, GLfloat elongfact, GLint ilon, GLint ilat)
{
    GLfloat cx, cy, cz;
    GLfloat x1, y1, z1;
    GLfloat x2, y2, z2;
...
Models* Models::createExpHornOBJ(GLfloat r1, GLfloat r2, GLfloat len, GLint ilon, GLint ilat)
{
    GLfloat cx, cy, cz;
    GLfloat x1, y1, z1;
    GLfloat x2, y2, z2;
...
Models* Models::createQuadHornOBJ(GLfloat r1, GLfloat r2, GLfloat len, GLint ilon, GLint ilat)
{
    GLfloat cx, cy, cz;
    GLfloat x1, y1, z1;
    GLfloat x2, y2, z2;
...
Models* Models::createHelicalTorusOBJ(GLfloat irad, GLfloat orad, GLfloat strFact, GLfloat begang, GLfloat endang, GLint ilon, GLint ilat)
{
    GLfloat cx, cy, cz;
    GLfloat x1, y1, z1;
    GLfloat x2, y2, z2;
...
Models* Models::createMobiusOBJ(GLfloat begv, GLfloat endv, GLint ilon, GLint ilat)
{
    GLfloat cx, cy, cz;
    GLfloat x1, y1, z1;
    GLfloat x2, y2, z2;
...
Models* Models::createTessellatedWallOBJ(GLfloat width, GLfloat height, GLint ilon, GLint ilat)
{
    resetArraySize(ilon, ilat);
...
/** \brief Convenience instance factory */
