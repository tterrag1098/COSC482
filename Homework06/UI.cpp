...
- B: Toggles the surface border.
- H: Toggles the surface color by height.
- W: Toggles the front face.
- C: Cycles through the culling modes.
- Q: Toggles culling on and off.
- P: Toggles perspective mode on and off.
...
void UI::keyPressed(sf::Event::KeyEvent keyevent)
{
    ...
    case sf::Keyboard::P:
        ge->setPrespective(!ge->getPrespective());
        ge->setProjectionMatrix();
        break;
